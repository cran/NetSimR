  ...
  ,tabsetPanel(
    tabPanel(
      ...
      ,sidebarLayout(
        ...
        ,mainPanel(
          h3(p('Welcome to our GLM Building tool. You can recover your previous work here. You can load the data and recover your previous work again to get all your input choices.')),
          br(),
